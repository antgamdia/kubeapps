...
# git remote add origin https://antgamdia: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@github.com/antgamdia/kubeapps.git 
# git push origin --delete sync-chart-changes-9.9.9
# git checkout  master
# git branch -D sync-chart-changes-9.9.9
###
    git checkout -b $targetBranch
    git add --all .
